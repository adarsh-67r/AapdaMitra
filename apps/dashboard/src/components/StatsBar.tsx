...
export default function StatsBar({ alerts, resources, reports }: Props) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-4 gap-px bg-border border border-border rounded-lg overflow-hidden mx-4 mt-4">
      <div className="bg-panel px-5 py-4 flex items-center gap-4">
      ...
      <div className="bg-panel px-5 py-4 flex flex-col justify-center gap-2.5">
