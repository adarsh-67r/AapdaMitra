...
export default function InspectorPanel({
  ...
  if (!report) {
    return (
      <section className="flex flex-col h-full bg-panel border border-border rounded-sm items-center justify-center px-4">
  ...
  return (
    <section className="flex flex-col h-full bg-panel border border-border rounded-sm overflow-y-auto">
